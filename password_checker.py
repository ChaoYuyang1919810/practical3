...
def is_valid_password(password):
    ...
    # Check if the password has at least one lowercase, uppercase, and digit
    if number_of_lower == 0 or number_of_upper == 0 or number_of_digit == 0:
        return False

    # If special characters are required, check for their presence
    if IS_SPECIAL_CHARACTER_REQUIRED and number_of_special == 0:
        return False

    # If we pass all checks, the password is valid
    return True
